...
# 1. Get a private key for the firebase service account and place it in the /secrets folder:
...
#    export GOOGLE_APPLICATION_CREDENTIALS="/path/to/secrets/mikor-oltanak-firebase-adminsdk.json"
